...
[* 始める]
 clone 不要で始めるなら、テンプレート [https://github.com/shinyaoguri/cosense-site-starter cosense-site-starter] の「Use this template」から。手順の詳細は [Quick start]。
...
[** ルート A: ブラウザだけで作る（おすすめ・clone 不要）]
 1. テンプレート [https://github.com/shinyaoguri/cosense-site-starter cosense-site-starter] を開き、緑の「Use this template」→「Create a new repository」で自分のリポジトリを作成
...
[** テンプレートから作った場合]
[https://github.com/shinyaoguri/cosense-site-starter cosense-site-starter] から作ったリポジトリは .github/workflows/build.yml を同梱済みなので deploy init は不要です。Settings → Pages → Source を GitHub Actions にするだけで動きます。
