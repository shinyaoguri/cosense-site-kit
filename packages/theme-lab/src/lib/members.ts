...
// Pulls a `code:members.yaml` block out of the page body and parses it. The
// convention mirrors theme-portfolio's `code:cv.yaml`: structured data lives
// in a named code block on the page itself.
